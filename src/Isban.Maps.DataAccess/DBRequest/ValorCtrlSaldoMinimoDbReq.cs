...
namespace Isban.Maps.DataAccess.DBRequest
{
    ...
    [ProcedureRequest("GET_MAPS_COMP_DEFINICION_CUR", Package = Package.ComponenteSaldoMinimo, Owner = Owner.Maps)]
    internal class ValorCtrlSaldoMinimoDbReq : FormularioBaseReq
    {
