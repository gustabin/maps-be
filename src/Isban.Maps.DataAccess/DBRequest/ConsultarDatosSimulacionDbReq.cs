...
{
    [ProcedureRequest("SP_CONSULTA_PASO_SIM", Package = Package.GraphToolsWizard, Owner = Owner.Maps)]
    internal class ConsultarDatosSimulacionDbReq : BaseRequest, IProcedureRequest
    {
