...
namespace Isban.Maps.DataAccess.DBRequest
{
    ...
    [ProcedureRequest("GET_MAPS_CTRL_DEFINICION_CUR", Package = Package.ComponenteOperacion, Owner = Owner.Maps)]
    internal class ValorCtrlOperacionDbReq : FormularioBaseReq
    { 
