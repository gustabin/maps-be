...
namespace Isban.Maps.DataAccess.DBRequest
{
    ...
    [ProcedureRequest("GET_MAPS_CTRL_DEFINICION_CUR", Package = Package.ComponentePeriodos, Owner = Owner.Maps)]
    internal class ValorCompPeriodosDbReq: FormularioBaseReq, IProcedureRequest
    {
