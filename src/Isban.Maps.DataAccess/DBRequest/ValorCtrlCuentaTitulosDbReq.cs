...
namespace Isban.Maps.DataAccess.DBRequest
{
    ...
    [ProcedureRequest("GET_MAPS_CTRL_DEFINICION_CUR", Package = Package.ComponenteCuentaTitulos, Owner = Owner.Maps)]
    internal class ValorCtrlCuentaTitulosDbReq : FormularioBaseReq
    {
