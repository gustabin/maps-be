...
namespace Isban.Maps.DataAccess.DBRequest
{
    ...
    [ProcedureRequest("GET_MAPS_COMP_DEFINICION_CUR", Package = Package.ComponenteFechaDesde, Owner = Owner.Maps)]
    internal class ValorCompFechaDesdeDbReq : FormularioBaseReq, IProcedureRequest
    {
