...
{
    [ProcedureRequest("SP_OBTENER_FONDOS", Package = Package.MapsTools, Owner = Owner.Maps)]
    internal class ConsultaFondosAGDDbReq : IProcedureRequest
    {
        [DBParameterDefinition(Direction = ParameterDirection.Input, Name = "P_COD_FONDO", BindOnNull = true, Type = OracleDbType.Varchar2)]
        public string CodigoFondo { get; set; }

        #region IProcedureRequest
        /// <summary>
