...
namespace Isban.Maps.DataAccess.DBRequest
{
    ...
    [ProcedureRequest("GET_MAPS_COMP_DEFINICION_CUR", Package = Package.ComponenteFechaHasta, Owner = Owner.Maps)]
    internal class ValorCompFechaHastaDbReq: FormularioBaseReq, IProcedureRequest
    {
