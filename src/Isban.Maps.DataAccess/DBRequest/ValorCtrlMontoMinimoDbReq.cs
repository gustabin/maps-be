...
namespace Isban.Maps.DataAccess.DBRequest
{
    ...
    [ProcedureRequest("GET_MAPS_COMP_DEFINICION_CUR", Package = Package.ComponenteMontoMinimo, Owner = Owner.Maps)]
    internal class ValorCtrlMontoMinimoDbReq : FormularioBaseReq, IProcedureRequest
    {
