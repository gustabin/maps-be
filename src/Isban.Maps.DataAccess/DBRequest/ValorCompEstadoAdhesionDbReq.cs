...
namespace Isban.Maps.DataAccess.DBRequest
{
    ...
    [ProcedureRequest("GET_MAPS_COMP_DEFINICION_CUR", Package = Package.ComponenteEstadoAdhesion, Owner = Owner.Maps)]
    internal class ValorCompEstadoAdhesionDbReq : FormularioBaseReq, IProcedureRequest
    {
